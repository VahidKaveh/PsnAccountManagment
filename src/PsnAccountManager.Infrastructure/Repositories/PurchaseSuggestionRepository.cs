...
public class PurchaseSuggestionRepository(PsnAccountManagerDbContext context) : GenericRepository<PurchaseSuggestion, int>(context), IPurchaseSuggestionRepository
{
